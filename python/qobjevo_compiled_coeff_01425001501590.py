...
class _UnitedStrCaller(_UnitedFuncCaller):
    ...
    def __call__(self, t, args={}):
        ...
        out.append(0.5 * tanh(4. * (1 * t - 0.0) / 0.32 - 2.) + 0.5)
        out.append(0.5 * tanh(4. * (t - 0.5 + 1.3176156917368248e-06) / 1.3176156917368248e-06 - 2.) - 0.5 * tanh(4. * (t - 0.5 - 1.3176156917368248e-06 - 0.013176156917368247) / 1.3176156917368248e-06 - 2.))
