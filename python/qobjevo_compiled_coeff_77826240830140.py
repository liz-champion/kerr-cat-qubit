...
class _UnitedStrCaller(_UnitedFuncCaller):
    ...
    def __call__(self, t, args={}):
        ...
        out.append(0.5 * tanh(4. * (1 * t - 0.0) / 0.32 - 2.) + 0.5)
        out.append(0.5 * tanh(4. * (1 * t - 0.0) / 0.32 - 2.) + 0.5)
        out.append(0.5 * tanh(4. * (t - 0.32) / 6.588078458684124e-07 - 2.) - 0.5 * tanh(4. * (t - 0.32 - 0.0065880784586841235) / 6.588078458684124e-07 - 2.))
        out.append(0.5 * tanh(4. * (t - 0.32658807845868415) / 2.5e-06 - 2.) - 0.5 * tanh(4. * (t - 0.32658807845868415 - 0.025) / 2.5e-06 - 2.))
        out.append(0.5 * tanh(4. * (t - 0.3515880784586842) / 6.588078458684124e-07 - 2.) - 0.5 * tanh(4. * (t - 0.3515880784586842 - 0.0065880784586841235) / 6.588078458684124e-07 - 2.))
